...
const docTemplate = `{
    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.OAuthLoginResponse"
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "307": {
                        ...
                        "headers": {
                            "Location": {
                                "type": "string",
                                "description": "Redirect URL to the OAuth provider's login page"
                            }
                        }
                    },
                    "400": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ExchangeCodeRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.ExchangeCodeResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.GenerateQRRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/handler.QRCodeResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/resend_confirmation": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Resend confirmation payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.ResendConfirmationRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.SignOutRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handler.VerifyQRRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/cancel_qr": {
            "post": {
                "description": "Cancel a QR code login attempt.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
    ...
    "definitions": {
        ...
        "handler.ExchangeCodeResponse": {
            "type": "object",
            "properties": {
                "message": {
                    "type": "string",
                    "example": "code exchanged successfully"
                },
                "session_token": {
                    "type": "string",
